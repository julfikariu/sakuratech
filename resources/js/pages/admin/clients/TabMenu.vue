...
const view_details = '/admin/clients/' + props.client_id;
const view_projects = '/admin/clients/' + props.client_id + '/projects';
const view_invoices = '/admin/clients/' + props.client_id + '/invoices';
const change_password = '/admin/clients/' + props.client_id + '/change-password';

const tabs = [
    { icon: User, label: 'Details', route: view_details },
    { icon: FolderOpen, label: 'Project', route: view_projects },
    { icon: FileText, label: 'Invoice', route: view_invoices },
