...
import { editPermissions } from '@/actions/App/Http/Controllers/Admin/RoleController';
					...
					<TableBody>
						<TableRow v-for="role in props.roles" :key="role.id">
							...
							<TableCell class="text-right flex gap-2 justify-end">
								...
								<ModalLink title="Manage Permissions" :href="editPermissions({ id: role.id }).url" variant="show" size="sm"
