<section id="working-process" class="relative py-16 bg-white">
	<div class="max-w-7xl mx-auto px-6">
		<p class="text-center text-sm tracking-widest font-semibold text-green-600">TECHNOLOGIES WE SPECIALIZE IN</p>
	...
	<!-- angled dark band -->
	<div class="absolute inset-x-0 bottom-0 top-24 -z-10">
		<div class="h-full bg-[#0b0b2a] transform -skew-y-2 origin-top"></div>
	</div>
		...
		<div class="mt-10 grid grid-cols-3 sm:grid-cols-4 md:grid-cols-6 lg:grid-cols-8 gap-8">
			...
			<div class="group flex flex-col items-center" data-aos="fade-up">
				<div class="flex flex-col items-center">
                    ...
                    2 0.3 3.4 1.7 5 3.4 2.5 2.6 5.3 5.5 11.4 5.5 
                    7 0 11.3-3.5 13-10.5-2.6 3.5-5.7 4.9-9.3 4.3 
                    -2-0.3-3.4-1.7-5-3.4C35 2.9 32.3 0 27 0zm-13 16c-7 0-11.3 3.5-13 10.5 
                    2.6-3.5 5.7-4.9 9.3-4.3 2 0.3 3.4 1.7 5 3.4 
                    2.5 2.6 5.3 5.5 11.4 5.5 7 0 11.3-3.5 13-10.5 
                    -2.6 3.5-5.7 4.9-9.3 4.3 -2-0.3-3.4-1.7-5-3.4 
                    C22 18.9 19.3 16 14 16z" />
					</svg>
					<span class="mt-3 text-sm text-gray-700">Tailwind CSS</span>
				</div>
