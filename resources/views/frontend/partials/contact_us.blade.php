		...
		<div class="grid grid-cols-1 lg:grid-cols-2 gap-10">
			...
			<div class="space-y-6" data-aos="fade-right">
				<div class="flex items-start space-x-4">
					...
					<div>
						...
						<p class="text-gray-600">123 Sakura Street, Dhaka, Bangladesh</p>
					</div>
				</div>
				...
				<div class="flex items-start space-x-4">
					...
					<div>
						...
						<p class="text-gray-600">info@sakurait.com</p>
					</div>
				</div>
			</div>
			...
			<form action="#" method="POST" class="bg-white shadow-lg rounded-lg p-8 space-y-6" data-aos="fade-left">
				...
				<textarea rows="5" placeholder="Your Message"
					class="w-full border border-gray-300 rounded-md px-4 py-3 focus:outline-none focus:ring-2 focus:ring-indigo-500"></textarea>
